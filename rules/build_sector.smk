...
rule prepare_sector_network:
    params:
        time_resolution=lambda w: config_provider("clustering", "temporal", "resolution_sector")(w),
        co2_budget=lambda w: config_provider("co2_budget")(w),
        conventional_carriers=lambda w: config_provider("existing_capacities", "conventional_carriers")(w),
        foresight=lambda w: config_provider("foresight")(w),
        costs=lambda w: config_provider("costs")(w),
        sector=lambda w: config_provider("sector")(w),
        industry=lambda w: config_provider("industry")(w),
        renewable=lambda w: config_provider("renewable")(w),
        lines=lambda w: config_provider("lines")(w),
        pypsa_eur=lambda w: config_provider("pypsa_eur")(w),
        length_factor=lambda w: config_provider("lines", "length_factor")(w),
        planning_horizons=lambda w: config_provider("scenario", "planning_horizons")(w),
        countries=lambda w: config_provider("countries")(w),
        adjustments=lambda w: config_provider("adjustments", "sector")(w),
        emissions_scope=lambda w: config_provider("energy", "emissions")(w),
        biomass=lambda w: config_provider("biomass")(w),
        RDIR=lambda w: RDIR,
        heat_pump_sources=lambda w: config_provider("sector", "heat_pump_sources")(w),
        heat_systems=lambda w: config_provider("sector", "heat_systems")(w),
        energy_totals_year=lambda w: config_provider("energy", "energy_totals_year")(w),
        direct_utilisation_heat_sources=lambda w: config_provider("sector", "district_heating", "direct_utilisation_heat_sources")(w),
        limited_heat_sources=lambda w: config_provider("sector", "district_heating", "limited_heat_sources")(w),
