...
def add_biomass(
    ...
    if options["electrobiofuels"]:
        ...
        n.add(
            ...
            bus3=spatial.oil.nodes,
            bus4="co2 atmosphere",
            bus5=spatial.h2.nodes,
            carrier="electrobiofuels",
            lifetime=costs.at["electrobiofuels", "lifetime"],
            efficiency=costs.at["electrobiofuels", "efficiency-biomass"]*0.3,
            efficiency2=costs.at["electrobiofuels", "efficiency-biomass"]*0.4,
            efficiency3=costs.at["electrobiofuels", "efficiency-biomass"]*0.3,
            efficiency5=-costs.at["electrobiofuels", "efficiency-hydrogen-biomass"], #efficiency2=-(costs.at["electrobiofuels", "efficiency-biomass"]/costs.at["electrobiofuels", "efficiency-hydrogen-fuel"])
            efficiency4=-costs.at["solid biomass", "CO2 intensity"] + costs.at["solid biomass", "CO2 intensity"]*(1-costs.at["electrobiofuels", "C in fuel"]),
